...
const SectionThree = () => {
 ...
 gap-0 h-[200vh] flex items-center justify-center bg-white z-50">

      <div className="cube-container px-[3vw] w-full h-full bg-black [clip-path:polygon(91%_0,100%_4.5%,100%_100%,0_100%,0_0)]">
